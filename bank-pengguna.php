...
$pengguna = query("SELECT * FROM proses_pengajuan ORDER BY id_pengajuan ASC");
...
<!--wrapper start-->
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="kategori">
                        ...
                        <div class="sub-menu">
                            <a href="bank-pengguna.php" target="isi"><i class=""></i><span>Data Bank Pengguna</span></a>
                        </div>
                        <div class="sub-menu">
    ...
    <div class="box-1 text-center" style=" min-width:83%;">
        <h2 style="font-size: 30px; color: #262626;" class="text-center">Daftar Bank Pengguna</h2>
            <div class="card-body">
